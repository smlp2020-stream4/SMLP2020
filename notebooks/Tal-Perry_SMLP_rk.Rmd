...
_RK-comment_. There is also much information about individual differences in the random-effect structure. I would use the post-hoc LMM because the VPs and CPs are very easy to intepret
...
_RK-comment_. We see much variation between subjects. One factor is certainly the skill, but I suspect some of them may also reflect different strategies to deal with the task.
